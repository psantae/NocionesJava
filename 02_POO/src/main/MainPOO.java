...
public class MainPOO {
	 public static void main(String[] args) {
		...
		p7 = new Persona ("Ana",37,60,0);		
		p7.direccion = new Direccion();
		p7.direccion.tipoVia = "Calle";
		
		//int codigopostal = 03730 //ojo, los numeros que empiezan por 0 son base octal
		//System.out.println(codigopostal); //imprime un numero raro
		//moraleja: los codigos postales, string
